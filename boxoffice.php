...
<html lang="en">
<head>
	<title>GooseTOR Search Box Office</title>
...
<main>
	...
	<div class="grid">
		<div class="col-6 grid-item thepiratebay">
			<h3>New content on ThePirateBay</h3>
			<ol>
			<?php
		...
		<div class="col-6 grid-item nyaa">
			<h3>New content on Nyaa.si</h3>
			<ol>
			<?php
